...
export function AuthView() {
  const { navigate, setUser, view, apiFetch } = useAuth();
  const [mode, setMode] = useState<"login" | "register">(view === "register" ? "register" : "login");
        ...
        >
          ...
          <div className="space-y-8">
            <h2 className="text-4xl xl:text-5xl font-extrabold leading-tight">
              ...
              <span className="bx-text-gradient">INVEST</span>
              <span className="text-white/30"> • </span>
              <span className="bx-silver">GROW</span>
            </h2>
            <p className="text-muted-foreground max-w-md leading-relaxed">
              The next-generation crypto trading platform. Industry-leading payouts, pro charting, and
              24/7 human support — all in one place.
            </p>
              ...
              {BENEFITS.map((b) => (
                <li key={b.title} className="flex items-start gap-3">
                  <div className="relative">
                    ...
                    <BadgeCheck className="absolute -bottom-1 -right-1 h-4 w-4 text-emerald-400 bg-[#02060f] rounded-full" />
                  </div>
                  <div>
          ...
          <div className="bx-glass rounded-xl p-4 max-w-sm">
            <div className="flex items-center gap-3">
              <div className="h-10 w-10 rounded-full flex items-center justify-center bg-gradient-to-br from-[#E0E0E0] to-[#9E9E9E] text-[#02060f] font-bold">
                S
              </div>
              <div>
              ...
              <TabsContent value="register" className="mt-5 space-y-3.5">
                <form onSubmit={handleRegister} className="space-y-3.5">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="space-y-1.5">
                      <Label htmlFor="rPwd" className="text-xs">
                        Password *
                      </Label>
                      <div className="relative">
                        <Input
                  ...
                  <div className="space-y-1.5">
                    <Label htmlFor="invitation" className="text-xs">
                      Invitation code *
                    </Label>
                    <div className="relative">
